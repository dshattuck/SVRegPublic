...
short int invnchoosek(short int , short int );


void fgt_predict(double * , double * , double * , short int , double  , short int , double , short int , short int , 
			     double * , 
			     double * , double *  , short int *);
...
void fgt_predict(double *y , double *xc , double *A_k  , short int Ny, double sigma , short int K , double e , short int d , short int pd ,  
			     double *v , 
			     double *dy , double *prods , short int *heads)
{
	

	short int p , i , j , m , k , t , tail , mbase , kn , xbase , head , ind;
...
short int invnchoosek(short int d , short int cnk)
{
	short int i , j , cted=1 , ctep , cte , p  ;
