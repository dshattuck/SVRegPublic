/*
 ...
 xc            The K center poshort ints of the training set (d x K) 
...
mex  -f mexopts_short intelAMD.bat -output fgt_model.dll fgt_model.c
...
short int nchoosek(short int  , short int );

short int idmax(double * , short int );


double ddist(double * , double * , short int );


void Kcenter(double * , short int  , short int  , short int , 
			 double * , short int * , short int * , short int * , 
			 double *);


void Compute_C_k(short int  , short int , double * , short int * , short int *);

void Compute_A_k(double * , double * , double *, double *  , double  , short int , short int  , short int , short int , short int , 
				 double * , 
...
void fgt_model(double * , double * , double  , short int  , short int , double ,
			   double * , double * , 
			   short int  , short int  ,
			   short int * , short int * , short int * , short int * , 
			   double * , double * , short int * , short int * , double * , double * , 
			   short int );
...

{
	...
	short int *indxc , *indx , *xhead , *xboxsz , *heads , *cinds;
	...
	if (nrhs > 4)
	{
		...
		K         = (short int)mxGetScalar(prhs[4]);
	...
	if (nrhs > 5)
	{
		...
		p          = (short int)mxGetScalar(prhs[5]);
    ...
    indxc          = (short int *)mxMalloc(K*sizeof(short int));
	
    indx           = (short int *)mxMalloc(Nx*sizeof(short int));
	
    xhead          = (short int *)mxMalloc(K*sizeof(short int));
	
    xboxsz         = (short int *)mxMalloc(K*sizeof(short int));
	
    heads          = (short int *)mxMalloc((d + 1)*sizeof(short int));
	
    cinds          = (short int *)mxMalloc(pd*sizeof(short int));
...
void fgt_model(double *x , double *w , double sigma , short int p , short int K , double e ,
			   double *xc , double *A_k ,
			   short int d , short int Nx ,
			   short int *indxc , short int *indx , short int *xhead , short int *xboxsz , 
			   double *dist_C , double *C_k , short int *heads , short int *cinds , double *dx , double *prods  ,
			   short int pd)
...
void Kcenter(double *x , short int d , short int Nx , short int K , 
			 double *xc , short int *indxc , short int *indx , short int *xboxsz , 
			 double *dist_C)
...
void Compute_C_k(short int d , short int p , 
				 double *C_k , 
				 short int *heads , short int *cinds)
{
	
    short int i , k , t , j , tail , head;
...
void Compute_A_k(double *x , double *w , double *xc, double *C_k , double sigma , short int d , short int Nx , short int p , short int K , short int pd , 
				 double *A_k , 
				 short int *indx  , double *dx , double *prods , short int *heads )
{
	
	short int n , i , k , t , tail , j , head , ind;
	
	short int nbase , ix2c , ix2cbase;
...
short int nchoosek(short int n , short int k)
{
	short int i , n_k = n - k , nchsk = 1;
...
double ddist(double *x , double *y , short int d)
{
	short int i;
...
short int idmax(double *x , short int N)
{
	short int i , k = 0;
