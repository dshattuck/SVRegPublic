...
function split_thickness_map_LE(subbase)

inner=readdfsGz([subbase, '.inner.cortex.dfs']);
pial=readdfsGz([subbase, '.pial.cortex.dfs']);
th=readdfs([subbase, '.LE-thickness_0-6mm.mid.cortex.dfs']);
...
writedfs([subbase, '.LE-thickness_0-6mm.left.mid.cortex.dfs'],mid_l);
...
writedfs([subbase, '.LE-thickness_0-6mm.right.mid.cortex.dfs'],mid_r);
