...
function split_thickness_map_iso(subbase)

inner=readdfsGz([subbase, '.inner.cortex.dfs']);
pial=readdfsGz([subbase, '.pial.cortex.dfs']);
th=readdfs([subbase, '.iso-thickness_0-6mm.mid.cortex.dfs']);
...
writedfs([subbase, '.iso-thickness_0-6mm.left.mid.cortex.dfs'],mid_l);
...
writedfs([subbase, '.iso-thickness_0-6mm.right.mid.cortex.dfs'],mid_r);
