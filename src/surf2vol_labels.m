...
function surf2vol_labels(subbasename, left_mid, right_mid, out_vol)
% Generates volumetric labels from surface labels
% subbasename: 
% left_mid, right mid: are dfs mid cortical surface files. The labels
% should be specified in the .label field of the dfs file
% out_vol: volume labels outputted
% subbasenale: base name of the brainsuite+svreg processed file. 

fprintf('Generating volumetric labels from surface labels\n');
...
%% Write labeled volume in a file
save_untouch_nii_gz(vol_lab,out_vol);
